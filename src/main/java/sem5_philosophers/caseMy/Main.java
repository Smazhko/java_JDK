...
/*
Для решения задачи создаём 5 философов, которые наследуются от THREAD,
и 5 палочек, в которых есть синхронизированные методы - занять и освободить палочку.
...
При успешной проверке (обе палочки свободны) стол занимает эти палочки через синхр методы самих палочек,
чтобы во время занимания в процесс не ворвался другой философ.
Далее - философ ест, наедается и освобождает палочки (синхр метод - пока не освободят, палочка не доступна другим).
